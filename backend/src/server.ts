...
// FIX: Corrected the path to serve static files from the frontend build directory.
...
app.get('*', (req, res) => {
  // FIX: Corrected the path to serve index.html from the frontend build directory.
